...
<html lang="es">
	...
	<body>
		...
		<ul>
<?php
    if (AccesoBD::comprobarUsuarioAdmin("alexisdlhb", "123456"))
...
$codigo = 1;
$estado = 0;
if (AccesoBD::usuarioActivo($codigo, $estado))
       echo "<li class='ok'>Correcto en  unit test usuarioActivo</li>";
    else 
        echo "<li class='error'>Error en unit test usuarioActivo</li>";
